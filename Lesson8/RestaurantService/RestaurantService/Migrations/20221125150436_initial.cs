        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    CurrentClientId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Clients_CurrentClientId",
                        column: x => x.CurrentClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_Tables_CurrentTableId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_CurrentClientId",
                table: "Orders",
                column: "CurrentClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_CurrentTableId",
                table: "Orders",
